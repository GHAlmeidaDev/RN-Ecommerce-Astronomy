...
import {
    ...
    decrementQuantity,
    incrementQuantity,
} from "../../redux/carrinho/bagSlice";
import { Entypo, MaterialIcons } from "@expo/vector-icons";
import { TouchableOpacity } from "react-native-gesture-handler";
import { SharedElement } from "react-navigation-shared-element";
import { useAppDispatch } from "../../redux/hooks";

interface CarrinhoCardProps extends BoxProps<Theme> {
    bagItem: BagItem;
    onImagePress(): void;
    onDeletePress(): void;
}
...
const CarrinhoCard: React.FC<CarrinhoCardProps> = ({
    bagItem,
    onDeletePress,
    onImagePress,
    ...rest
        ...
        <Box borderRadius='s' overflow='hidden' marginVertical="s" flexDirection="row" bg="white" {...rest}>
            ...
            <Box flex={1} width={width * 0.7} justifyContent="space-between">
                ...
                >
                    ...
                    <Text variant="body">{`R$${bagItem.product.price}`}</Text>
                </Box>
            </Box>
        </Box>
    );
...
export default React.memo(CarrinhoCard);
