...
import CarrinhoCard from "../../components/cards/CarrinhoCard";
import Layout from "../../components/alls/Layout";
import BottomTab from "../../components/navigation/BottomTab";
import Header from "../../components/navigation/Header";
import {
    CarrinhoScreenNavigationProps,
    CarrinhoScreenRouteProps,
} from "../../navigation/ScreensNavigationRouteProps";
import { removeFromBag } from "../../redux/carrinho/bagSlice";
...
import CheckoutView from "../../components/alls/CheckoutView";
import { Image, Alert} from "react-native";

interface CarrinhoScreenProps {
    navigation: CarrinhoScreenNavigationProps;
    route: CarrinhoScreenRouteProps;
}
...
const CarrinhoScreen: React.FC<CarrinhoScreenProps> = ({ navigation, route }) => {
    const theme = useTheme<Theme>();
    const [display, setDisplay] = useState(false);

    const dispatch = useAppDispatch();
    const carrinhoItems = useAppSelector((state) => state.bag.carrinhoItems);
    ...
    return (
        <Layout bg={carrinhoItems!.length > 0 ? 'background' : 'white'}>
            {display && (
                <CheckoutView
                    ...
                    {carrinhoItems && carrinhoItems.length > 0 && (
                        <Box>
                            ...
                            >
                                ...
                                <Text variant="body2">{`R$${total}`}</Text>
                            </Box>
