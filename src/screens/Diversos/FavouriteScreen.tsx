...
import FavoritoCard from "../../components/cards/FavoritoCard";
...
const FavouriteScreen: React.FC<FavouriteScreenProps> = ({
    ...
    const favoritos = useAppSelector((state) => state.favourite.favourites);
    ...
    return (
        <Layout bg={favoritos.length > 0 ? "background" : "white"}>
            <Header
