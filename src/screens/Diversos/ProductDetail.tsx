...
import Selectables from "../../components/alls/Selectables";
import SelectableColors from "../../components/alls/SelectableColors";
import { useAppDispatch } from "../../redux/hooks";
import { addToBag } from "../../redux/carrinho/bagSlice";
import { SIZES } from "../../redux/data_types";
import { addToFavourite } from "../../redux/favourite/favouriteSlice";
import ImageCarousel from "../../components/alls/ImageCarousel";
                            ...
                            !route.params.item.has_size && (
                                <Box p="m">
                                    <Text
                                        ...
                                        variant="description"
                                    >
                                        Sem tamanhos ou cores para esse produto
                                    </Text>
                                </Box>
                            )}
                        <Box>
            ...
            <ScrollView>
                ...
                >
                    ...
                    <Box flex={1} alignItems="flex-end">
                        <Text variant="body2">{`R$${route.params.item.price}`}</Text>
                    </Box>
                </Box>
                {route.params.item.has_size && (
                    <Box>
